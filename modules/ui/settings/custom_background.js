...
export function uiSettingsCustomBackground() {
    var _customCount = prefs('custom-template-count');
    ...
    function render(selection) {
        ...
        function clickCancel() {
            ...
            _customCount -= 1;
            // Temporary method to delete layers REMOVE LATERRR
            prefs('custom-template-count',_customCount);
        ...
        function clickSave() {
            ...
            prefs('background-custom-template-' + (++_customCount) , _currSettings.template);
            prefs('custom-template-count', _customCount);
            this.blur();
            modal.close();
